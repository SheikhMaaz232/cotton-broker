        ...
        <div class="content-page">
                                ...
                                <div class="page-title-box">
                                    <div class="btn-group float-right">
                                        <ol class="breadcrumb hide-phone p-0 m-0">
                                            ...
                                            <li class="breadcrumb-item active">List of Government Documents</li>
                                        </ol>
                                    </div>
                                    <h4 class="page-title">List Of Government Documents</h4>
                                </div>
                            </div>
                        </div>
            ...
            <!-- end page title end breadcrumb -->
                        ...
                        <div class="form-group button-items mb-0 text-right">
                            <a href="{{ route('govt-document.create') }}" class="btn btn-primary waves-effect waves-light">Create Document</a>
                        </div>
                        <br>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card m-b-30">
                        <div class="card-body">
                            <form action="{{ route('govt-document.list') }}" method="get">
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <tr id="row_{{$doc->id}}">
                                            ...
                                            <td>
                                                @if(!empty($permission->edit_access) && $permission->edit_access == 1 || Auth::user()->is_admin == 1)
                                                    <a href="{{ route('govt-document.edit',['id'=>$doc->id]) }}" title="Edit"><i class="fa fa-edit"></i></a>
                                                @endif
                ...
                bootbox.confirm("Do you really want to delete record?", function(result) {
                    if(result){
                        $.ajax({
                            ...
                            url: '{{ url('govt-document/delete') }}'+'/'+documentId,
                            type: 'DELETE',
                            data: { id:documentId },
