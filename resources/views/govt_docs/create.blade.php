                                ...
                                <div class="page-title-box">
                                    <div class="btn-group float-right">
                                        <ol class="breadcrumb hide-phone p-0 m-0">
                                            ...
                                            <li class="breadcrumb-item active">Govt Documents</li>
                                        </ol>
                                    </div>
                                    <h4 class="page-title">Govt Documents</h4>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-lg-12">
                                <div class="card m-b-30">
                                    <div class="card-body bpv-form project-management donor-reg">
                                        <form action="{{ route('govt-document.save') }}" method="post" enctype="multipart/form-data">
                                            @csrf
                                            ...
                                            <div class="form-inline">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="select2 form-control mb-3 custom-select"
                                                        ...
                                                        @foreach( $dropDownData['govtDocumentTypes'] as $key=>$value)
                                        ...
                                        <strong>{{ $message }}</strong>
                                                ...
                                                <div class="form-group">
                                                    <h6 class="light-dark">Sub Department<span style="color: red">*</span></h6>
                                                    <input type="text" class="form-control" name="type"
                                                           id="type"  value="{{ old('type', !empty($doc->type) ? $doc->type : '')  }}" placeholder="Enter Sub Department">
                                                    @error('type')
                                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
